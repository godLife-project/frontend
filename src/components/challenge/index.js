...
//   challTitle: z.string(),
//   challDescription: z.string(),
//   challCategoryIdx: z.string(),
//   totalClearTime: z.string(),
//   minParticipationTime: z.string(),
...
//     // challStartTime이 빈 문자열인 경우(유저 참여형 챌린지) 현재 날짜로 설정
//     const startTime =
//       challengeType === "1" || !data.challStartTime
...
//     const submitData = {
//       ...data,
//       challState: parseInt(challengeType, 10),
...
//                   <Label htmlFor="minParticipationTime">
//                     참여 가능한 최소 시간
//                   </Label>
//                   <Controller
//                     control={form.control}
...
//                 <div className="space-y-2">
//                   <Label htmlFor="totalClearTime">총 클리어 시간</Label>
//                   <Controller
//                     control={form.control}
//                     name="totalClearTime"
//                     render={({ field }) => (
...
//           {/* 챌린지 기간 설정 섹션 - 챌린지 유형에 따라 다르게 표시 */}
//           <Card className="bg-white shadow-sm">
//             <CardHeader>
    ...
    try {
      ...
      const submitData = {
        ...
        challCategoryIdx: isNaN(parseInt(data.challCategoryIdx, 10))
          ...
          : parseInt(data.challCategoryIdx, 10),
        challStartTime: startTime,
        // userId를 추가 (API 요구사항에 따라 조정 필요)
        userJoin: "1", // 유저가 참여한다는 의미로 설정
      };
