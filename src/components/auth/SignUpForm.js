      ...
      <div className="bg-white p-6 rounded-3xl shadow-md w-full max-w-sm">
        <div className="flex justify-between">
          ...
          <div className="flex flex-col space-x-4 pt-2">
            <Button
              type="button"
              className="text-xs bg-transparent border-none p-0 h-3 text-gray-400 hover:underline hover:text-blue-500 hover:bg-white focus:outline-none shadow-none ring-0"
            >
              계정이 있으시나요?
            </Button>
            <Button
              type="button"
              className="text-xs bg-transparent border-none p-0 h-3 pt-3  text-gray-400 hover:underline hover:text-blue-500 hover:bg-white focus:outline-none shadow-none ring-0"
            >
              로그인하러 가기
            </Button>
          </div>
