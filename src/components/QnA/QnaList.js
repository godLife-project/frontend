...
//     if (
//       newParams.get("sort") === "createdAt" &&
//       newParams.get("order") === "desc"
//     ) {
...
//                 <DropdownMenuContent
//                   align="end"
//                   className="w-64 bg-white border shadow-md"
//                 >
...
//             총 {totalPosts}개의 문의 중 {qnaList.length}개 표시 (페이지{" "}
...
const QnAList = () => {
  ...
  // 제목 자르기 함수 추가
  const truncateTitle = (title, maxLength = 5) => {
    ...
    <div className="container mx-auto">
      <Card className="max-w-5xl mx-auto">
        <CardHeader className="flex  items-center justify-between">
          <div>
            <CardTitle className="mt-3 mb-3">나의 1:1 문의 내역</CardTitle>
            {/* <CardDescription>
              문의하신 내용과 답변을 확인하실 수 있습니다.
            </CardDescription> */}
          </div>
          <div className="flex gap-2">
            ...
            >
              <PenSquare className="h-4 w-4" />
              <span className="sm:inline">문의하기</span>
            </Button>
          </div>
        </CardHeader>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b bg-gray-50">
                    <th
                      className="w-14 text-center cursor-pointer p-3 text-sm font-medium"
                      onClick={() => handleSortChange("num")}
                    >
                      <span className="sm:inline">번호</span>
                      {renderSortIcon("num")}
                    </th>
                    <th
                      className="cursor-pointer p-3 text-center text-sm font-medium"
                      onClick={() => handleSortChange("title")}
                    >
                      제목 {renderSortIcon("title")}
                    </th>
                    <th
                      className="w-20 sm:w-28 text-center cursor-pointer p-3 text-sm font-medium"
                      onClick={() => handleSortChange("createdAt")}
                    >
                      <span className="hidden sm:inline">등록일</span>
                ...
                <tbody>
                  {qnaList.map((qna) => (
                    <tr
                      ...
                      onClick={() => handleViewQnA(qna.qnaIdx)}
                    >
                      <td className="text-center font-medium p-3 text-sm">
                        {qna.num}
                      </td>
                      <td className="p-3">
        ...
        <CardFooter className="flex justify-between items-center">
          {/* <div className="text-sm text-muted-foreground">
            총 {totalPosts}개의 문의 중 {qnaList.length}개 표시
