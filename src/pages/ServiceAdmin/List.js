...
// //                       activePage === "추천 루틴관리" ? "bg-blue-800" : ""
// //                     }`}
// //                   >
// //                     <button
...
// //           {activePage === "추천 루틴관리" && (
// //             <div className="bg-white p-6 rounded-md shadow">
// //               <h2 className="text-xl font-semibold mb-4">추천 루틴관리</h2>
// //               <p className="mb-4">
// //                 여기에 추천 루틴관리 관련 컨텐츠가 표시됩니다.
// //               </p>
// //               <button className="px-4 py-2 bg-blue-500 text-white rounded-md">
// //                 새 루틴 추가
// //               </button>
...
const AdminDashboard = () => {
  ...
  // 챌린지 관리 페이지인지 확인
  const isChallengeManagement = activePage === "챌린지 관리";
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 overflow-auto flex flex-col">
        {/* 챌린지 관리가 아닐 때만 헤더 표시 */}
        {!isChallengeManagement && (
          <header className="bg-white p-4 shadow flex justify-between items-center">
            <h1 className="text-xl font-semibold">{activePage}</h1>
          </header>
        )}

        {/* 메인 컨텐츠 - 챌린지 관리일 때는 패딩 제거 */}
        <main className={`flex-1 ${isChallengeManagement ? "" : "p-6"}`}>
          {/* 컴포넌트 관리 페이지 */}
          {activePage === "컴포넌트 관리" && <CompSystem />}
